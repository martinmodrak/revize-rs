...
```{r}
dokonceno <- sum(!is.na(hlavni_data$ended.hlavni), na.rm = TRUE)
rozpracovano <- sum(!is.na(hlavni_data$kategorie_respondenta) & is.na(hlavni_data$ended.hlavni))
```
...
plots$dulezite_celkem <- plot_kategorie_kompetence(expanded, "dulezite", popis_pro_plot(hlavni_data, "duchovni_zivot.dulezite"))
plots$dulezite_celkem
```

```{r}
plots$zvladam_celkem <- plot_kategorie_kompetence(expanded, "zvladam", popis_pro_plot(hlavni_data, "duchovni_zivot.zvladam"))
plots$zvladam_celkem

```

```{r}
plots$rozvijim_celkem <- plot_kategorie_kompetence(expanded, "rozvijim", popis_pro_plot(hlavni_data, "duchovni_zivot.rozvijim"))
plots$rozvijim_celkem

```

```{r}
plots$skauting_celkem <- plot_kategorie_kompetence(expanded, "skauting", popis_pro_plot(hlavni_data, "duchovni_zivot.skauting"))
