...
plot_spokojenost(spokojenost %>% mutate(studium_ve_meste_strediska = fct_recode(studium_ve_meste_strediska, Ne = "Ne, většinu roku trávím mimo místo, kde mám svoje středisko")), "studium_ve_meste_strediska")
