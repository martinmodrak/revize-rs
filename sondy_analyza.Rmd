...
sondy_program_tmp <- sondy %>% select(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce) %>% mutate_all(funs(recode(.,"Ano"=T,"Ne"=F,"N/A"=NA))) %>% filter(!is.na(roverske_akce_probehle_2roky_zavody))

sondy_program <- sondy_program_tmp %>% 
  mutate(k2 = kmeans(sondy_program_tmp,2)$cluster,
         k3 = kmeans(sondy_program_tmp,3)$cluster,
         k4 = kmeans(sondy_program_tmp,4)$cluster,
         k5 = kmeans(sondy_program_tmp,5)$cluster,
         k6 = kmeans(sondy_program_tmp,6)$cluster,
         k7 = kmeans(sondy_program_tmp,7)$cluster,
         k8 = kmeans(sondy_program_tmp,8)$cluster,
         k9 = kmeans(sondy_program_tmp,9)$cluster,
         k10 = kmeans(sondy_program_tmp,10)$cluster)
         
plot_cluster(sondy_program, "k2", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  

plot_cluster(sondy_program, "k3", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  
plot_cluster(sondy_program, "k4", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  
plot_cluster(sondy_program, "k5", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  
plot_cluster(sondy_program, "k6", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  

plot_cluster(sondy_program, "k7", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  
plot_cluster(sondy_program, "k8", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  
plot_cluster(sondy_program, "k9", vars(roverske_akce_probehle_2roky_zavody:roverske_akce_kurzy_vzdelavaci_akce))  
