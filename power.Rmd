...
formula_ideal <- brmsformula(potreba_rozvoje ~ (1|kompetence) + (0 + mo(zivotni_spokojenost)|kompetence) + (0 + funkce|kompetence) + (0 + vek|kompetence) , family = cumulative("logit"))
