...
# Odchody na přechodu do roverského věku {#odchody-lidi}
...
devtools::load_all()
knitr::opts_chunk$set(echo=FALSE, cache=TRUE, fig.width = default_plot_width, fig.height = default_plot_height)
...
## Odchody v roverském věku {#odchodyroveri}
