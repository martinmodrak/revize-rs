...
,
			list(name = 'Krátké rozvojové akce!',
				text = 'Krátké rozvojové akce jsou díra na skautském trhu. Organizace krátkých seminářů, motivačních a tematických večerů může sehrát zásadní roli pro osvětu a funkční rozvoj v organizaci nejen v roverském tématu - a to zejména díky přijatelnému a rychlému formátu. Dobrou zkušenost s tímto formátem mají i někteří roverští zpravodajové - například organizátoři ostravských roverských večerů.')
,
