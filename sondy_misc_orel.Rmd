...
```{r}
summarise_by(podil_casu_u_detskych_oddilu_junak_celkove)
```
...
summarise_by_souhlas(souhlas_pomoc_s_detskym_oddilem_je_forma_roveringu)
summarise_by_souhlas(souhlas_rs_program_je_relaxace_od_vedeni_detskych_oddilu)
summarise_by_souhlas(souhlas_hlavni_je_vlastni_rs_cinnost_pomoc_v_oddilech_az_druhorada)
summarise_by_souhlas(souhlas_roveri_potrebuji_stezku)
summarise_by_souhlas(souhlas_roveri_potrebuji_plan_cinnosti)
summarise_by_souhlas(souhlas_roveri_potrebuji_vlastni_rs_akce)
summarise_by_souhlas(souhlas_roveri_potrebuji_letni_tabor_nebo_expedici)
summarise_by_souhlas(souhlas_roveri_potrebuji_vedouciho_kmene)
summarise_by_souhlas(souhlas_roveri_potrebuji_zastoupeni_na_strediskovych_radach)
```
