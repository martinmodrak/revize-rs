...
ncat = 4
repeat {
  test_data <- simulate_data(N = 200, N_questions = 4, N_fixed = 2, N_random_groups = numeric(0), ncat = ncat, N_monotonic = 0, questions_correlation = TRUE, subset_questions = 3)
...
#set.seed(6847567)
sbc_steps <- 100
sbc_results <- sbc(model, function() { simulate_data(N = 200, N_questions = 4, N_fixed = 2, ncat = 4, N_random_groups = c(2,4),  N_monotonic = 2, questions_correlation = TRUE)}, N_steps = sbc_steps, control = list(adapt_delta = 0.95))
