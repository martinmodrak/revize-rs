...
plot_all_indices <- function(marginals_to_show, m, title = m) {
  ...
  for(ind in index_vals) {
    print(plot_single_marginal(marginals_to_show, m, ind, title = title))
  }  
}
```
...
```{r}
other_marginals <- setdiff(unique(marginals_to_show$marginal), c("sexmuz", "byl_na_jinem_nez_rs_kurzu", "byl_na_rs_kurzu") )
