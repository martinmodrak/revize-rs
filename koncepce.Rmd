...
*	Aktualizovat a osvěžovat pohled na rovering:
    ...
    *	Přistupovat k němu vizionářsky, přinášet aktuální témata.
...
* Pomáhat cílům roverského věku a zakončení skautské výchovy
* Směr vytyčený roverskou metodikou považujeme za vhodný, zejména stavební kameny roverského programu
  * Metodice však chybí téma sebepřijetí
* Roverský věk mám mít jasné zakončení. Je zároveň zakončením cílené výchovy Junáka. Je to důležitý předěl. Možná mluvit jako o nástroji, implementaci do nástrojů. Pracovat se zakončením...
* Implementace sebepřijetí (do metodiky, ale i jinam)
* Tvořit roverský program spolu s lidmi z roverských seberozvojových kurzů (FONS, Fonticulus, Svatoplukovy Pruty, ...)
* Ke stávajícím nástrojům --- budou-li zachovány
  * Výzvy a projekty 
  ...
  * Roverské kurzy, tábory
    * Účast na seberozvojových kurzech nebo roverských táborech by měla být běžnější součástí roverské zkušenosti a Junák by ji měl podporovat. Zde nemluvíme jen o finanční podpoře (která je poměrně štědrá), ale také o “vážnost”, která se takové účasti (ne)přikládá. Zejména v kontextu současného hladu po kvalifikačních kurzech by přínos seberozvojových akcí pro naplnění cílů skautské výchovy neměl být opomenut.
* Junák má mít konkrétně zpracovaný začátek roveringu (odhadem minimálně první dva roky)
...
*  Přinést konkrétní cestu roverským věkem (minimálně) pro mladší roverský věk. Program by měl na jedné straně obsahovat konkrétní cestu a programy směřující ke skautské dospělosti. 
* Na druhé straně má za úkol vést mladého rovera k uchopení vlastního rozvoje do svých rukou, naučit jej práci s vlastní motivací, připravit jej na závěrečnou fázi roveringu, kdy už se má plně projevit samostatný seberozvoj a život podle tří principů skautingu.
...
* Přinášet do RP aktuální témata, udržovat rovering na špici práce s mladými lidmi, inspirativní, motivační - jako tomu nejspíš bylo při založení roveringu RBP. (Toto by měla dělat programová část roverského odboru?)
* Stavět roverský program dle aktuální vývojové psychologie.
* Začlenit chybějící téma sebepřijetí do metodiky pro RS a do kompetencí skautské výchovy.
