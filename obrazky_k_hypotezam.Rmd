...
expanded_pro_plot <- expanded %>% 
  ...
  mutate(nad_prumer_populace = kompetence_odpoved > mean(kompetence_odpoved)) %>%
  ungroup() %>%
  pivot_longer(c("nad_median", "nejvyse", "nad_prumer_populace"), names_to = "meritko", values_to = "meritko_ano") 
