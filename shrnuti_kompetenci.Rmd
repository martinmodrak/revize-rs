...
output:
  ...
  # word_document:
  #   toc: yes
  #   reference_docx: public_data/output_\template.docx
...
```{r}
plots$zvladam_age <- plot_kompetence_by(hlavni_data_long, "zvladam", age)
plots$zvladam_age
...
```{r}
plots$dulezite_age <- plot_kompetence_by(hlavni_data_long, "dulezite", age)
plots$dulezite_age
...
```{r}
plots$rozvijim_age <- plot_kompetence_by(hlavni_data_long, "rozvijim", age)
plots$rozvijim_age
...
```{r}
plots$skauting_age <- plot_kompetence_by(hlavni_data_long, "skauting", age)
plots$skauting_age
