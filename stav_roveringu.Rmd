...
plots$komunikace_vek <- hlavni_data %>% plot_binarni_s_nejistotou(nazvy_komunikace, by = age, names_prefix = "komunikacni_kanaly_existujici.", na.rm = TRUE, facet = TRUE) + plot_annotation(paste0("Komunikační kanály dle věku ", i), "Kde bys nejraději sledovala aktuální informace o roveringu?")
