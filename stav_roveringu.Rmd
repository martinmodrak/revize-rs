...
hlavni_data %>% # filter(kategorie_respondenta != "nikdy_spolecenstvi") %>%
  mutate(`Je ve společenství` = kategorie_respondenta == "nyni_spolecenstvi", `Byl ve společenství` = kategorie_respondenta == "drive_spolecenstvi", `Nikdy nebyl` = kategorie_respondenta == "nikdy_spolecenstvi") %>%
  plot_binarni_s_nejistotou(c("Je ve společenství","Byl ve společenství", "Nikdy nebyl"), age, legend_label = "") +
