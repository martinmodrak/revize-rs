...
Jako singles bereme lidi bez společenství. 
...
plots$spokojenost_junak <- hlavni_data %>% filter(je_rover) %>% plot_summary_mc(spokojenost_s_fungovanim_v_junaku, "Spokojenost s fungováním v Junáku\nJen bez roverske zkušenosti")
plots$spokojenost_junak
