...
Respondenti tomuto odpovídají - `scales::percent(podile_vstoupili_do_11ti_let)` jich vstoupilo do Junáka když jim bylo méně než 11 let.
...
Ptali jsme se též, jestli se roverem stanu "automaticky" když dovrším skautský věk - vypadá to, že zhruba v polovině středisek se jasně rozlišuje mezi roverem a členem v roverském věku.
...
V otázkách výše je taky vidět, že "mít vlastní akce" je (z vnějšku) o dost menší nárok než "funkční společenství". 
...
TODO: Proč není zaveden? Pomáhá tam, kde je zaveden?
