...
toc-title: "Obsah"
abstract: "Tento dokument shrnuje odpovědi na všechny otázky týkající se přímo roveringu a snaží se jim dát nějaký kontext. Neřešíme zde demografické složení respondentů, ani otázky na kompetence."
output:
  word_document:
    toc: yes
...
```{r}
plots$co_pomaha_roveringu_organizace <- plot_summary_mc(hlavni_data, co_pomaha_roveringu, "Roveringu dle mé vlastní\nzkušenosti znatelně pomáhá:", subtitle = "jen otázky související s s Junákem jako celkem", include_values = c("zpravodal","vyssi_mista", "akce_kratke", "akce_dlouhe", "socialni_site"))
