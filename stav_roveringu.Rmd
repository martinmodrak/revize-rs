...
### Věk vstupu do RS společenství {#vek_vstupu}

Zdá se, že málokdo vstupuje do kmene později než těsně po skautském věku.

```{r vek_vstupu_do_kmene, fig.cap='Rozložení věku vstupu do kmene. Věk vstupu určen z otázek "Jak dlouho jsi ve společenství" a "Věk", proto lze určit jen u těch, kdo nyní jsou ve společenství.'}
...
Tato data jsou ale zkreslena směrem dolů tím, že obecně máme hodně mladších respondentů (16ti letý respondent nemohl vstoupit do kmene před 16tým rokem). Můžeme se tedy na stejný graf podívat separátně pro několik věkových kategorií: 
...
Nejsilnějším argumentem pro téměř výhradně rané vstupy tak je pohled na vývoj v čase: vidíme, že kolem 16tého roku jsou zhruba 3/4 respondentů ve společenství, s rostoucím věkem pak postupně klesá podíl roverů, co jsou ve společenství a srovnatelně přibývá "odpadlíků", zatímco kategorie "Nikdy nebyl ve společenství" se s věkem nijak výrazně nezmenšuje a zůstává kolem 20%. 
